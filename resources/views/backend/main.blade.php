            ...
            <div class="modal-dialog modal-sm modal-notify modal-danger" role="document">
                ...
                <div class="modal-content text-center">
                    ...
                    <div class="modal-footer flex-center">
                        <a href="https://mdbootstrap.com/product/material-design-for-bootstrap-pro/"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <select class="mdb-select colorful-select dropdown-info">
                                <option value="" disabled="disabled">Choose time period</option>
                        ...
                        <div class="col-md-6 mb-4 text-center">
                            ...
                            <h5>
                                ...
                                <button type="button" class="btn btn-info btn-sm p-2" data-toggle="tooltip"
                                        data-placement="top"
                                        title="Percentage change compared to the same period in the past">
                                    <i class="fa fa-question"></i>
                                </button>
                            </h5>
        ...
        <div class="card p-2 mb-5">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <!--Blue select-->
                    <select class="mdb-select colorful-select dropdown-primary mx-2">
                        <option value="" disabled="disabled" selected="selected">Show only</option>
                        <option value="1">All
                            <span>
                                            (2000)</span>
                        </option>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <!--Blue select-->
                    <select class="mdb-select colorful-select dropdown-primary mx-2">
                        <option value="" disabled="disabled" selected="selected">Filter segments</option>
            ...
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <select class="mdb-select colorful-select dropdown-primary mt-2 hidden-md-down">
                        <option value="" disabled="disabled">Rows number</option>
                        <option value="1" selected="selected">10 rows</option>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $('#folder-1').click(function () {
                toastr.error("Folder 1 has been clicked!", "Folder 1", {"positionClass": "toast-top-right"});
            });
